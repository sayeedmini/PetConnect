...
function VetListPage() {
    ...
    () =>
      vets.map((vet, index) => {
        ...
        return {
          ...
          isOpen: Boolean(vet?.isCurrentlyOpen || clinic?.isOpenNow),
        };
      }),
    [vets],
  );
  ...
  const formatFee = (fee) =>
    fee === null || fee === undefined ? 'BDT N/A' : `BDT ${fee}`;
        ...
        <section className="mb-8 space-y-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-bold text-[#002045] sm:text-4xl">
                Discover top-rated veterinary care near you.
              </h1>
            </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 flex items-center justify-between border-t border-slate-200 pt-4">
                        <div>
                          ...
                          <div className="mt-1 text-xl font-bold text-[#002045]">
                            {formatFee(clinic.consultationFee)}
                          </div>
                        </div>
                        <Link
                          to={`/vets/${clinicId}`}
